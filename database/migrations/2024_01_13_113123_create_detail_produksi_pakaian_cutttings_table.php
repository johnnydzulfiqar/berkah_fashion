...
return new class extends Migration
{
    ...
    {
        Schema::create('detail_produksi_pakaian_cuttings', function (Blueprint $table) {
            $table->string('kode_detail_produksipakaian_cutting')->primary();
            $table->string('kode_produksipakaian_cutting');
    ...
    {
        Schema::dropIfExists('detail_produksi_pakaian_cuttings');
    }
};
