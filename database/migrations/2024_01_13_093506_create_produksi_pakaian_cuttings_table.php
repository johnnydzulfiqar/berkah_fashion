...
return new class extends Migration
{
    ...
    {
        Schema::create('produksi_pakaian_cuttings', function (Blueprint $table) {
            $table->string('kode_produksipakaian_cutting')->primary();
            ...
            $table->integer('status_produksi_cutting')->default(1);
    ...
    {
        Schema::dropIfExists('produksi_pakaian_cuttings');
    }
};
