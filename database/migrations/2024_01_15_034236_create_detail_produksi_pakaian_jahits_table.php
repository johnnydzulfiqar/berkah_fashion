...
return new class extends Migration
{
    ...
    {
        Schema::create('detail_produksi_pakaian_jahits', function (Blueprint $table) {
            $table->string('kode_detail_produksipakaian_jahit')->primary();
            $table->string('kode_produksipakaian_jahit');
    ...
    {
        Schema::dropIfExists('detail_produksi_pakaian_jahits');
    }
};
