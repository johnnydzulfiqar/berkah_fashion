...
<html lang="en">
    ...
    <body>
        <table>
            <caption>DETAIL PRODUKSI PAKAIAN CUTTING</caption>
            <caption>KODE PRODUKSI : ({{ $kode_produksipakaian_cutting}})</caption>
            ...
            <tbody>
                @foreach ($dataProduksiCutting as $dataProduksi)
                    <tr>
                        <td>{{ $dataProduksi->kode_detail_produksipakaian_cutting  }}</td>
