    ...
    <table class="datatable">
        ...
        <thead>
            <tr>
                ...
                <th>Gagal (pakaian)</th>
                <th>Upah Kerja (per pakaian) Rp.</th>
                <th>Upah Kerja</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($dataProduksi as $data)
                <tr>
                    <td>{{ $data->kode_detail_produksipakaian_cutting ?? 'Data Tidak Ada'}}</td>
                    <td>{{ $data->kode_produksipakaian_cutting ?? 'Data Tidak Ada'}}</td>
                    ...
                    <td>Rp.{{ number_format($data->R_KeProduksiPakaian->R_KeRencanaProduksi->biaya_cutting, 0, ',', '.') }}</td>
