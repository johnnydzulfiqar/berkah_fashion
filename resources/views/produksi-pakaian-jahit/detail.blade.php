...
<html lang="en">
    ...
    <body>
        <table>
            <caption>DETAIL PRODUKSI PAKAIAN JAHIT</caption>
            <caption>KODE PRODUKSI : ({{ $kode_produksipakaian_jahit}})</caption>
            ...
            <tbody>
                @foreach ($dataProduksiJahit as $dataProduksi)
                    <tr>
                        <td>{{ $dataProduksi->kode_detail_produksipakaian_jahit }}</td>
