...
<body>
    ...
    <div class="judul">
        ...
        <caption>LAPORAN PEMBELIAN BAHANBAKU</caption> 
    ...
    <table class="datatable">
        ...
        <tbody>
            ...
            @foreach ($kodePembelian->detailBeliBahanBakus as $detail)
                <tr>
                    <td>{{ $detail->kode_detail_belibahanbaku ?? 'Data Tidak Ada' }}</td>
                    <td>{{ $detail->kode_belibahanbaku ?? 'Data Tidak Ada' }}</td>
                    <td>{{ $detail->R_KeBeliBahanBaku->tgl_beli ?? 'Data Tidak Ada' }}</td>
                    ...
                    <td>{{ $detail->R_KeBeliBahanBaku->R_KeStatusBeli->status_beli ?? 'Data Tidak Ada' }}</td>
                </tr>
            @endforeach
        @endforeach
        </tbody>
